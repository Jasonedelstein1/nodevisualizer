import o, { createElement, useContext, createContext, useRef, useLayoutEffect, useEffect, useId, useCallback, useMemo, Fragment, useInsertionEffect, forwardRef, Component, useState } from "react";
...
function requireReactDomClient_production() {
  ...
  var Scheduler = requireScheduler(), React = o, ReactDOM = require$$2;
...
function filter$2(array2, pattern) {
...
var character = 0;
var characters = "";
function node(value, root2, parent, type, props, children2, length2, siblings) {
            ...
            if (character2 === 123)
              if (offset === 0)
                ...
                switch (atrule === 99 && charat(characters2, 3) === 110 ? 100 : atrule) {
                  ...
                  case 109:
                  case 115:
                    parse(value, reference, reference, rule && append(ruleset(value, reference, reference, 0, 0, rules, points, type, rules, props = [], length2, children2), children2), rules, children2, length2, points, rule ? props : children2);
                    break;
                  default:
  ...
  for (var i = 0, j2 = 0, k2 = 0; i < index2; ++i)
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j2 = points[i])), z2 = value; x2 < size; ++x2)
      if (z2 = trim(j2 > 0 ? rule[x2] + " " + y2 : replace(y2, /&\f/g, rule[x2])))
        props[k2++] = z2;
  return node(value, root2, parent, offset === 0 ? RULESET : type, props, children2, length2, siblings);
}
            ...
            return combine(children2 = element.props, function(value) {
              switch (match(value, callback = /(::plac\w+|:read-\w+)/)) {
                ...
                case ":read-write":
                  ...
                  assign(element, { props: filter$2(children2, callback) });
                  break;
                // :placeholder
                case "::placeholder":
...
}, be = "style[".concat(f, "][").concat(y$2, '="').concat(v, '"]'), Ee = new RegExp("^".concat(f, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), Ne = function(e2, t2, n2) {
...
var Ie = function(e2) {
  ...
  o2.setAttribute(f, m$1), o2.setAttribute(y$2, v);
  var i2 = Ce();
...
var Me = new ke(), ze = Fe(), $e = o.createContext({ shouldForwardProp: void 0, styleSheet: Me, stylis: ze });
$e.Consumer;
...
var Ke = z(v), Qe = (function() {
  ...
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.isStatic && !n2.hash) if (this.staticRulesId && t2.hasNameForId(this.componentId, this.staticRulesId)) o2 = ie(o2, this.staticRulesId);
      ...
      var r2 = ae(Xe(this.rules, e3, t2, n2)), s2 = x$2(M(this.baseHash, r2) >>> 0);
...
function it(e2, r2, s2) {
  ...
  function O2(e3, r3) {
    return (function(e4, r4, s3) {
      ...
      var N3 = ie(p3, d3);
      return E3 && (N3 += " " + E3), g3.className && (N3 += " " + g3.className), w3[L(S3) && !A.has(S3) ? "class" : "className"] = N3, s3 && (w3.ref = s3), createElement(S3, w3);
    })(D2, e3, r3);
  }
  O2.displayName = y2;
...
const { schedule: frame$1, cancel: cancelFrame, state: frameData, steps: frameSteps } = /* @__PURE__ */ createRenderBatcher(typeof requestAnimationFrame !== "undefined" ? requestAnimationFrame : noop$1, true);
let now$1;
function clearTime() {
  now$1 = void 0;
}
...
const frameloopDriver = (update) => {
  ...
  return {
    start: (keepAlive = true) => frame$1.update(passTimestamp, keepAlive),
...
const dimensionValueTypes = [number, px, percent, degrees$1, vw, vh, auto];
...
function useRender(Component2, props, ref, { latestValues }, isStatic, forwardMotionProps = false) {
  ...
  const renderedChildren = useMemo(() => isMotionValue(children2) ? children2.get() : children2, [children2]);
...
function calcChildStagger(children2, child, delayChildren, staggerChildren = 0, staggerDirection = 1) {
  const index2 = Array.from(children2).sort((a2, b) => a2.sortNodePosition(b)).indexOf(child);
...
class VisualElementDragControls {
  ...
  stop(event, panInfo) {
    ...
    if (onDragEnd) {
      frame$1.postRender(() => onDragEnd(finalEvent, finalPanInfo));
    }
  }
  /**
   * @internal
...
const theme = {
  colors: {
    primary: "#1a6aff",
    primaryGlow: "rgba(26, 106, 255, 0.4)",
    secondary: "#fc5130",
    secondaryGlow: "rgba(252, 81, 48, 0.4)",
    neutral: "#0a0a0d",
    inverse: "#f8f3de"
  },
  typography: {
    secondary: { weight: 800, family: "Roboto" }
  },
  breakpoints: {
    mobile: 768,
    desktop: 1200
  ...
  nodeSize: {
    desktop: {
      primary: { width: 180, height: 60 },
      secondary: { width: 160, height: 50 },
      tertiary: { width: 140, height: 40 }
    },
    mobile: {
      primary: { width: 140, height: 45 },
      secondary: { width: 120, height: 40 },
      tertiary: { width: 100, height: 35 }
    }
  },
  physics: {
    linkDistance: 180,
    // Much larger distance for spread-out web
    linkStrength: 0.6,
    // Moderate strength for natural web tension
    chargeStrength: -400,
    // Strong repulsion to push nodes apart
    collideRadius: 80,
    // Larger collision radius to prevent overlap
    alpha: 0.3,
    // More energy for better spreading
    alphaDecay: 0.01,
    // Slower decay for longer settling time
    velocityDecay: 0.9
    // Less friction for more natural movement
  }
};
const getCategoryColor = (category) => {
  const categoryColors = {
    acquisition: theme.colors.primary,
    tracking: theme.colors.primary,
    analytics: theme.colors.secondary,
    optimization: theme.colors.secondary,
    targeting: theme.colors.secondary,
    management: theme.colors.secondary,
    automation: theme.colors.secondary,
    sales: theme.colors.inverse,
    nurture: theme.colors.inverse,
    fulfillment: theme.colors.inverse,
    operations: theme.colors.inverse
  };
  return categoryColors[category] || theme.colors.neutral;
};
const getCategoryGlow = (category) => {
  const categoryGlows = {
    acquisition: theme.colors.primaryGlow,
    tracking: theme.colors.primaryGlow,
    analytics: theme.colors.secondaryGlow,
    optimization: theme.colors.secondaryGlow,
    targeting: theme.colors.secondaryGlow,
    management: theme.colors.secondaryGlow,
    automation: theme.colors.secondaryGlow,
    sales: "rgba(248, 243, 222, 0.4)",
    nurture: "rgba(248, 243, 222, 0.4)",
    fulfillment: "rgba(248, 243, 222, 0.4)",
    operations: "rgba(248, 243, 222, 0.4)"
  };
  return categoryGlows[category] || "rgba(10, 10, 13, 0.4)";
};
const nodeVariants = {
  initial: {
    scale: 0,
...
const NodeContainer = dt(motion.div)`
  position: absolute;
  display: flex;
  align-items: center;
  justify-content: center;
  width: ${(props) => props.$nodeSize.width}px;
  height: ${(props) => props.$nodeSize.height}px;
  border-radius: 8px;
  cursor: grab;
  user-select: none;
  ...
  const baseColor = getCategoryColor(props.$category);
  return props.$isHovered || props.$isDragging ? baseColor : `${baseColor}aa`;
}};
  
  box-shadow: ${(props) => {
  const glow = getCategoryGlow(props.$category);
  const intensity = props.$isHovered ? "18px" : props.$isDragging ? "22px" : "10px";
  const opacity = props.$isHovered ? "0.7" : props.$isDragging ? "0.9" : "0.4";
  return `0 0 ${intensity} ${glow.replace("0.4", opacity)}`;
}};
  ...
  &:hover {
    ...
    box-shadow: ${(props) => {
  const glow = getCategoryGlow(props.$category);
  return `0 0 20px ${glow.replace("0.4", "0.7")}`;
}};
  }
`;
const NodeText = dt.span`
  color: ${(props) => getCategoryColor(props.$category)};
  font-family: 'Roboto', sans-serif;
  font-weight: ${(props) => {
  if (props.$tier === "primary") return "700";
  if (props.$tier === "secondary") return "600";
  return "500";
}};
  font-size: ${(props) => {
  if (props.$nodeSize.width < 100) return "11px";
  if (props.$nodeSize.width < 140) return "12px";
  if (props.$nodeSize.width < 160) return "13px";
  return "14px";
}};
  text-align: center;
  line-height: 1.1;
...
const TouchPointNode = o.memo(({
  ...
  if (node2.id === "ad-creative") {
    console.log("TouchPointNode ad-creative:", { x: node2.x, y: node2.y });
  }
  const handleDragStart = () => {
    onDragStart(node2.id);
  };
  const handleDrag = (_event, info) => {
    if (node2.x !== void 0 && node2.y !== void 0) {
      onDrag(node2.id, node2.x + info.delta.x, node2.y + info.delta.y);
    }
  };
  const handleDragEnd = () => {
    onDragEnd(node2.id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    NodeContainer,
    {
      ...
      role: "button",
      tabIndex: 0,
      "aria-label": `${node2.label} - ${node2.category} touchpoint`,
      onKeyDown: (e) => {
        if (e.key === "Enter" || e.key === " ") {
          onHover(isHovered ? null : node2.id);
        }
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(NodeText, { $tier: node2.tier, $nodeSize: nodeSize, $category: node2.category, children: node2.label })
    }
  );
});
const WebSVG = dt.svg`
  ...
  z-index: 1;
`;
const ElasticLine = dt.line`
  stroke: ${(props) => props.$color};
  stroke-width: ${(props) => props.$isHighlighted ? 3 : 1}px;  /* Thinner lines for cleaner look */
  stroke-opacity: ${(props) => props.$isHighlighted ? 1 : 0.3};  /* Much dimmer when not highlighted */
  fill: none;
  filter: ${(props) => props.$isHighlighted ? `drop-shadow(0 0 6px ${props.$color}99)` : "none"};
  transition: all 0.3s ease-out;
  
  /* Add subtle pulsing animation for highlighted lines */
  animation: ${(props) => props.$isHighlighted ? "webPulse 1.5s ease-in-out infinite" : "none"};
...
`;
const getConnectionPoint = (fromNode, toNode, nodeSize) => {
  ...
  if (absAngle <= cornerAngle || absAngle >= Math.PI - cornerAngle) {
    offsetX = angle >= -Math.PI / 2 && angle <= Math.PI / 2 ? halfWidth : -halfWidth;
    offsetY = offsetX * Math.tan(angle);
    offsetY = Math.max(-halfHeight, Math.min(halfHeight, offsetY));
  } else {
    offsetY = angle >= 0 ? halfHeight : -halfHeight;
...
const ElasticWebLine = o.memo(({
  link: link2,
  isHighlighted,
  getNodeSize
}) => {
  const source = typeof link2.source === "string" ? { id: link2.source, x: 0, y: 0 } : link2.source;
  const target = typeof link2.target === "string" ? { id: link2.target, x: 0, y: 0 } : link2.target;
  if (source.id === "ad-creative" && target.id === "conversions-api") {
    console.log("Debug line coords:", {
      source: { id: source.id, x: source.x, y: source.y },
      target: { id: target.id, x: target.x, y: target.y }
    });
  }
  const lineColor = useMemo(() => {
    return getCategoryColor(source.category);
  }, [source.category]);
  const sourcePoint = useMemo(() => {
    if (!source.x || !source.y) return { x: 0, y: 0 };
    const sourceSize = getNodeSize(source.tier);
    return getConnectionPoint(source, target, sourceSize);
  }, [source.x, source.y, source.tier, target, getNodeSize]);
  const targetPoint = useMemo(() => {
    if (!target.x || !target.y) return { x: 0, y: 0 };
    const targetSize = getNodeSize(target.tier);
    return getConnectionPoint(target, source, targetSize);
  }, [target.x, target.y, target.tier, source, getNodeSize]);
  const distance2 = useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WebSVG, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ElasticLine,
    {
      x1: sourcePoint.x,
      y1: sourcePoint.y,
...
const useResponsive = (containerRef) => {
  ...
  const getNodeSize = (tier) => {
    return dimensions.isMobile ? theme.nodeSize.mobile[tier] : theme.nodeSize.desktop[tier];
  };
  const isTablet = dimensions.width >= theme.breakpoints.mobile && dimensions.width < theme.breakpoints.desktop;
  const isDesktop = dimensions.width >= theme.breakpoints.desktop;
  return {
    dimensions,
    getNodeSize,
...
function selection_merge(context) {
  ...
  for (var groups0 = this._groups, groups1 = selection2._groups, m0 = groups0.length, m1 = groups1.length, m2 = Math.min(m0, m1), merges = new Array(m0), j2 = 0; j2 < m2; ++j2) {
    for (var group0 = groups0[j2], group1 = groups1[j2], n = group0.length, merge = merges[j2] = new Array(n), node2, i = 0; i < n; ++i) {
...
function hslConvert(o2) {
  ...
  o2 = o2.rgb();
  var r = o2.r / 255, g2 = o2.g / 255, b = o2.b / 255, min = Math.min(r, g2, b), max = Math.max(r, g2, b), h = NaN, s = max - min, l = (max + min) / 2;
  if (s) {
...
function interpolateString(a2, b) {
  ...
  return s.length < 2 ? q2[0] ? one(q2[0].x) : zero(b) : (b = q2.length, function(t) {
    for (var i2 = 0, o2; i2 < b; ++i2) s[(o2 = q2[i2]).i] = o2.x(t);
    return s.join("");
  });
}
...
function interpolateTransform(parse2, pxComma, pxParen, degParen) {
  ...
  return function(a2, b) {
    ...
    rotate2(a2.rotate, b.rotate, s, q2);
    skewX(a2.skewX, b.skewX, s, q2);
    scale2(a2.scaleX, a2.scaleY, b.scaleX, b.scaleY, s, q2);
    a2 = b = null;
    return function(t) {
      var i = -1, n = q2.length, o2;
      while (++i < n) s[(o2 = q2[i]).i] = o2.x(t);
      return s.join("");
    };
  };
}
...
function create(node2, id2, self) {
  ...
  function start2(elapsed) {
    ...
    for (i = 0, j2 = -1; i < n; ++i) {
      if (o2 = self.tween[i].value.call(node2, node2.__data__, self.index, self.group)) {
        tween[++j2] = o2;
      }
    }
    tween.length = j2 + 1;
...
function transition_selectAll(select) {
  ...
  for (var groups = this._groups, m2 = groups.length, subgroups = [], parents = [], j2 = 0; j2 < m2; ++j2) {
    for (var group = groups[j2], n = group.length, node2, i = 0; i < n; ++i) {
      if (node2 = group[i]) {
        for (var children2 = select.call(node2, node2.__data__, i, group), child, inherit2 = get(node2, id2), k2 = 0, l = children2.length; k2 < l; ++k2) {
...
function add(tree, x2, y2, d) {
  ...
  var parent, node2 = tree._root, leaf = { data: d }, x0 = tree._x0, y0 = tree._y0, x1 = tree._x1, y1 = tree._y1, xm, ym, xp, yp, right, bottom, i, j2;
  ...
  while (node2.length) {
    ...
    if (parent = node2, !(node2 = node2[i = bottom << 1 | right])) return parent[i] = leaf, tree;
  }
  xp = +tree._x.call(null, node2.data);
  yp = +tree._y.call(null, node2.data);
  if (x2 === xp && y2 === yp) return leaf.next = node2, parent ? parent[i] = leaf : tree._root = leaf, tree;
  do {
  ...
  return parent[j2] = node2, parent[i] = leaf, tree;
}
...
function tree_cover(x2, y2) {
  ...
  if (isNaN(x0)) {
    ...
    var z2 = x1 - x0 || 1, node2 = this._root, parent, i;
...
function tree_find(x2, y2, radius) {
  var data, x0 = this._x0, y0 = this._y0, x1, y1, x22, y22, x3 = this._x1, y3 = this._y1, quads = [], node2 = this._root, q2, i;
  if (node2) quads.push(new Quad(node2, x0, y0, x3, y3));
  ...
  while (q2 = quads.pop()) {
    if (!(node2 = q2.node) || (x1 = q2.x0) > x3 || (y1 = q2.y0) > y3 || (x22 = q2.x1) < x0 || (y22 = q2.y1) < y0) continue;
    if (node2.length) {
...
function tree_remove(d) {
  ...
  var parent, node2 = this._root, retainer, previous, next2, x0 = this._x0, y0 = this._y0, x1 = this._x1, y1 = this._y1, x2, y2, xm, ym, right, bottom, i, j2;
...
function collide(radius) {
  ...
  function initialize() {
    ...
    radii = new Array(n);
    for (i = 0; i < n; ++i) node2 = nodes[i], radii[node2.index] = +radius(node2, i, nodes);
  }
...
function link(links) {
  var id2 = index, strength = defaultStrength, strengths, distance2 = constant(30), distances, nodes, count, bias, random, iterations = 1;
  if (links == null) links = [];
...
function simulation(nodes) {
  var simulation2, alpha2 = 1, alphaMin = 1e-3, alphaDecay = 1 - Math.pow(alphaMin, 1 / 300), alphaTarget = 0, velocityDecay = 0.6, forces = /* @__PURE__ */ new Map(), stepper = timer(step), event = dispatch("tick", "end"), random = lcg();
  if (nodes == null) nodes = [];
  function step() {
    tick();
  ...
  return simulation2 = {
    ...
    randomSource: function(_2) {
      return arguments.length ? (random = _2, forces.forEach(initializeForce), simulation2) : random;
    },
    force: function(name, _2) {
      return arguments.length > 1 ? (_2 == null ? forces.delete(name) : forces.set(name, initializeForce(_2)), simulation2) : forces.get(name);
    },
    ...
    on: function(name, _2) {
      return arguments.length > 1 ? (event.on(name, _2), simulation2) : event.on(name);
    }
  };
}
function manyBody() {
  var nodes, node2, random, alpha2, strength = constant(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = 0.81;
  function force(_2) {
    var i, n = nodes.length, tree = quadtree(nodes, x, y).visitAfter(accumulate);
    for (alpha2 = _2, i = 0; i < n; ++i) node2 = nodes[i], tree.visit(apply);
  }
  function initialize() {
    if (!nodes) return;
    var i, n = nodes.length, node3;
    strengths = new Array(n);
    for (i = 0; i < n; ++i) node3 = nodes[i], strengths[node3.index] = +strength(node3, i, nodes);
  }
  ...
  function apply(quad, x1, _2, x2) {
    ...
    var x3 = quad.x - node2.x, y2 = quad.y - node2.y, w2 = x2 - x1, l = x3 * x3 + y2 * y2;
    if (w2 * w2 / theta2 < l) {
      if (l < distanceMax2) {
        if (x3 === 0) x3 = jiggle(random), l += x3 * x3;
        if (y2 === 0) y2 = jiggle(random), l += y2 * y2;
        if (l < distanceMin2) l = Math.sqrt(distanceMin2 * l);
        node2.vx += x3 * quad.value * alpha2 / l;
        node2.vy += y2 * quad.value * alpha2 / l;
      }
      return true;
...
const useForceSimulation = ({
  ...
  const simulationNodes = useMemo(
    () => nodes.map((node2) => ({ ...node2 })),
    [nodes]
  );
  const simulationLinks = useMemo(() => {
    const links = [];
    nodes.forEach((node2) => {
      node2.connections.forEach((connectionId) => {
  ...
  useEffect(() => {
    ...
    const simulation$1 = simulationRef.current;
    simulation$1.force(
      "link",
      link(simulationLinks).id((d) => d.id).distance(theme.physics.linkDistance).strength(theme.physics.linkStrength)
    ).force(
      "charge",
      manyBody().strength(theme.physics.chargeStrength)
    ).force("center", center(
      dimensions.width / 2,
      dimensions.height / 2
    )).force(
      "collision",
      collide().radius(theme.physics.collideRadius)
    ).alpha(theme.physics.alpha).alphaDecay(theme.physics.alphaDecay).velocityDecay(theme.physics.velocityDecay);
    const handleTick = () => {
      if (animationFrameRef.current) {
        cancelAnimationFrame(animationFrameRef.current);
      }
      animationFrameRef.current = requestAnimationFrame(() => {
        onTick(simulationNodes, simulationLinks);
    ...
    return () => {
      simulation$1.on("tick", null);
      if (animationFrameRef.current) {
        cancelAnimationFrame(animationFrameRef.current);
      }
    };
  }, [simulationNodes, simulationLinks, dimensions, onTick]);
  const updateNodePosition = (nodeId, x2, y2) => {
    const node2 = simulationNodes.find((n) => n.id === nodeId);
    if (node2 && simulationRef.current) {
      node2.fx = x2;
      node2.fy = y2;
      simulationRef.current.alpha(0.1).restart();
    }
  };
  const releaseNode = (nodeId) => {
    const node2 = simulationNodes.find((n) => n.id === nodeId);
    if (node2 && simulationRef.current) {
      node2.fx = null;
      node2.fy = null;
...
const TOUCHPOINTS = [
  // Primary Nodes (3)
  {
    ...
    label: "Ad Creative",
    tier: "primary",
    connections: ["conversions-api", "event-targeting", "retargeting"],
  ...
  },
  {
    ...
    tier: "primary",
    connections: ["server-tracking", "attribution", "custom-conversions"],
    category: "tracking"
  },
  {
    id: "server-tracking",
    ...
    tier: "primary",
    connections: ["attribution", "custom-conversions", "crm"],
    category: "tracking"
  },
  // Secondary Nodes (7)
  {
    id: "attribution",
    label: "Accurate Attribution",
    tier: "secondary",
    connections: ["custom-conversions", "sales-auto"],
    category: "analytics"
  },
  {
    ...
    tier: "secondary",
    connections: ["event-targeting", "retargeting"],
    category: "optimization"
  },
  {
    id: "event-targeting",
    label: "Event-based Targeting",
    tier: "secondary",
    connections: ["retargeting", "ai-assistant"],
    category: "targeting"
  },
  {
    id: "retargeting",
    label: "Re-targeting",
    tier: "secondary",
    connections: ["estimate-gen", "follow-up"],
    category: "targeting"
  },
  {
    id: "crm",
    ...
    tier: "secondary",
    connections: ["sales-auto", "ai-assistant"],
    category: "management"
  },
  {
    id: "sales-auto",
    label: "Sales Automations",
    tier: "secondary",
    connections: ["ai-assistant", "admin-auto"],
    category: "automation"
  },
  {
    id: "ai-assistant",
    ...
    tier: "secondary",
    connections: ["follow-up", "admin-auto"],
    category: "automation"
  },
  // Tertiary Nodes (5)
  {
    ...
    tier: "tertiary",
    connections: ["estimate-sched", "follow-up"],
    category: "sales"
  },
  {
    id: "estimate-sched",
    label: "Estimate Scheduling",
    tier: "tertiary",
    connections: ["follow-up", "invoice"],
    category: "sales"
  },
  {
    id: "follow-up",
    label: "Intelligent Follow Up",
    tier: "tertiary",
    connections: ["invoice", "admin-auto"],
    category: "nurture"
  },
  {
    id: "invoice",
    ...
    tier: "tertiary",
    connections: ["admin-auto"],
    category: "fulfillment"
  },
  {
    id: "admin-auto",
    label: "Admin Automations",
    tier: "tertiary",
    connections: [],
    category: "operations"
  }
];
const NetworkContainer = dt.div`
  width: 100%;
  height: 100%;
  min-height: 400px;
  position: relative;
  overflow: hidden;
  background: linear-gradient(135deg, ${theme.colors.neutral} 0%, #151518 100%);
  border-radius: 8px;
  font-family: 'Roboto', sans-serif;
  ...
  &::before {
    ...
    background: radial-gradient(
      circle at 30% 20%,
      ${theme.colors.primaryGlow} 0%,
      transparent 50%
    ),
    radial-gradient(
      circle at 70% 80%,
      ${theme.colors.secondaryGlow} 0%,
      transparent 50%
    );
    opacity: 0.2;
    pointer-events: none;
...
const LoadingOverlay = dt.div`
  ...
  align-items: center;
  justify-content: center;
  background: ${theme.colors.neutral}cc;
  color: ${theme.colors.inverse};
  font-family: ${theme.typography.secondary.family};
...
const NetworkVisualizer = ({
  ...
  const { dimensions, getNodeSize } = useResponsive(containerRef);
  const handleTick = useCallback((nodes, links) => {
    setSimulationNodes([...nodes]);
    setSimulationLinks([...links]);
    if (!isInitialized && nodes.some((n) => n.x && n.y)) {
  ...
  const handleDrag = useCallback((nodeId, x2, y2) => {
    const now2 = Date.now();
    const lastUpdate = throttleRef.current[nodeId] || 0;
    if (now2 - lastUpdate >= 16) {
      updateNodePosition(nodeId, x2, y2);
      throttleRef.current[nodeId] = now2;
    }
  }, [updateNodePosition]);
  ...
  }, [hoveredNode, reheatSimulation]);
  const connectedLinks = useMemo(() => {
    if (!hoveredNode) return [];
    return simulationLinks.filter((link2) => {
      const source = typeof link2.source === "string" ? link2.source : link2.source.id;
      const target = typeof link2.target === "string" ? link2.target : link2.target.id;
      return source === hoveredNode || target === hoveredNode;
    });
  }, [hoveredNode, simulationLinks]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    NetworkContainer,
    {
      ...
      className,
      role: "application",
      "aria-label": "Interactive Client Acquisition Network Visualizer",
      children: [
        !isInitialized && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingOverlay, { children: "Initializing Network..." }),
        simulationLinks.map((link2, index2) => {
          const source = typeof link2.source === "string" ? link2.source : link2.source.id;
          const target = typeof link2.target === "string" ? link2.target : link2.target.id;
          const isHighlighted = connectedLinks.some((cl) => {
            const clSource = typeof cl.source === "string" ? cl.source : cl.source.id;
            const clTarget = typeof cl.target === "string" ? cl.target : cl.target.id;
            return clSource === source && clTarget === target || clSource === target && clTarget === source;
          });
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            ElasticWebLine,
            {
            ...
            `${source}-${target}-${index2}`
          );
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NodesContainer, { children: simulationNodes.map((node2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          TouchPointNode,
          {
            node: node2,
            nodeSize: getNodeSize(node2.tier),
            isHovered: hoveredNode === node2.id,
            isDragging: draggedNode === node2.id,
...
const init = (selector2, options = {}) => {
  const container = document.querySelector(selector2);
  if (!container) {
    console.error(`NetworkVisualizer: Container not found for selector "${selector2}"`);
    return;
  }
  ...
  root2.render(o.createElement(NetworkVisualizer, mergedOptions));
};
const autoInit = () => {
  const containers = document.querySelectorAll(".network-visualizer, [data-network-visualizer]");
  containers.forEach((container) => {
    if (container instanceof HTMLElement) {
      const options = {};
      if (container.dataset.theme) {
        options.theme = container.dataset.theme;
      }
      if (container.dataset.responsive !== void 0) {
        options.responsive = container.dataset.responsive === "true";
      }
      if (container.dataset.autoplay !== void 0) {
        options.autoplay = container.dataset.autoplay === "true";
      }
      const selector2 = container.id ? `#${container.id}` : ".network-visualizer";
      init(selector2, options);
    }
  });
};
const NetworkVisualizerGlobal = {
  init,
  version: "1.0.0"
};
if (typeof window !== "undefined") {
  window.NetworkVisualizer = NetworkVisualizerGlobal;
...
export {
  NetworkVisualizer,
  NetworkVisualizerGlobal as default,
  init
};
//# sourceMappingURL=network-visualizer.es.js.map
